...
export const products = [
    ...
    {title: 'Swish Nails', type: 'service', description: 'Pastry sweet carrot cake fruitcake cheesecake jelly-o gummi bears liquorice. Wafer sugar plum sweet sesame snaps cake soufflé. Powder bear claw pie jelly-o danish jelly beans sesame snaps soufflé liquorice.', price: '6.99', rating: 3, reviews: reviews, image: 'imgs/nails.jpg'},
...
export const packageOptions = [
    {title: 'Practical Support', description: 'We can provide assistance with:', features: ['Bathing and Shaving', 'Medication', 'Dressing and Undressing', 'Continence Care', 'Hairdressing and Pampering', 'Shopping and meal preparation', 'Recovering from illness', 'Getting to appointments'], img: 'https://www.belleviecare.co.uk/wp-content/uploads/2020/10/philippa-james-photography-77-e1602409059618.jpg'},
    ...
    {title: 'Products', description: 'We take care of your home, making sure you have the right environment to thrive and feel comfortable in.', features: ['Cleaning', 'Dry cleaning', 'Clothes washing, Ironing', 'Home help (changing light bulbs, taking the bins out, basic DIY)', 'Pet care'], img: 'imgs/products.jpg'},
    {title: 'Services', description: 'Our Wellbeing Support Workers are trained to offer support for those with specialist needs such as returning home from hospital, or end of life care. We can also help people living with:', features: ['Dementia', 'Parkinson’s', 'Cancer'], img: 'imgs/hairdresser.jpg'}
];
