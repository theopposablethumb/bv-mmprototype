...
export const products = [
    {title: 'Speaking Day Clock', description: 'Pastry sweet carrot cake fruitcake cheesecake jelly-o gummi bears liquorice. Wafer sugar plum sweet sesame snaps cake soufflé. Powder bear claw pie jelly-o danish jelly beans sesame snaps soufflé liquorice.', price: '19.99', rating: 5, reviews: reviews, image: 'imgs/talking-clock.webp'}, 
    {title: 'Bathroom aids', description: 'Pastry sweet carrot cake fruitcake cheesecake jelly-o gummi bears liquorice. Wafer sugar plum sweet sesame snaps cake soufflé. Powder bear claw pie jelly-o danish jelly beans sesame snaps soufflé liquorice.', price: '29.99', rating: 5, reviews: reviews, image: 'imgs/bathaids.webp'}, 
